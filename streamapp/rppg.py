...
from streamapp.camera_ import Camera
from streamapp.detector import ROIDetector
...
class RPPG(QObject):
    ...
    def on_frame_received(self, frame):
        ...
        """
        #print("on_frame_received importado correctamente")
        rawimg = frame.copy()
    ...
    def print_signal(self):
        """Imprime los valores de self.signal en la consola."""
        signal_ = self.signal
        return signal_
