...
from streamapp.detector import ROIDetector, fill_roimask
from streamapp.mainwindow import MainWindow
from streamapp.rppg import RPPG, RppgResults
import imutils
...
rppg_instance = RPPG()# Crea una instancia de la clase RPPG
mainwindow_instance = MainWindow()# Crea una instancia de la clase MainWindw
class VideoCamera(object):
	...
	def get_frames(self):
		while True:
			...
			_, buffer = cv2.imencode(".jpg", frame_with_roi)
			frame_bytes = buffer.tobytes()
			yield frame_bytes
class IPWebCam(object):
	def __init__(self):
		self.url = "http://10.20.53.82:8080/shot.jpg"
